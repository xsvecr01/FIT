...
**/
	...
	if((*RootPtr))
	{
		//ve stromu se uz nachazi uzel se stejnym klicem, prepisu jeho obsah
		if(K == (*RootPtr)->Key)
		{
		...
		else BSTInsert(&(*RootPtr)->RPtr, K, Content);	
	}
	//vytvoreni uzlu
	else
	{
